...
func New() *Mgmt {
	...
	libmgmt.NoPgp = true
	libmgmt.Seeds = config.GetStringSlice("etcdendpoints")
	libmgmt.ClientURLs = config.GetStringSlice("etcdclientaddress")
	libmgmt.ServerURLs = config.GetStringSlice("etcdpeeraddress")
