...
var defaultGroupOptions = map[string]*api.OptionGroup{
	...
	"profile.SMB-large-file-EC": {"profile.SMB-large-file-EC",
		[]api.VolumeOption{{Name: "features.cache-invalidation", OnValue: "on"},
			...
			{Name: "client.event-threads", OnValue: "4"},
			{Name: "server.event-threads", OnValue: "4"}},
		"Enable this profile for use cases consisting of mostly large files like video surveillance, backup, video streaming and others, with SMB access of a Eurasure coded volume"},
	"profile.FUSE-large-file-EC": {"profile.FUSE-large-file-EC",
		[]api.VolumeOption{{Name: "features.cache-invalidation", OnValue: "on"},
			...
			{Name: "client.event-threads", OnValue: "4"},
			{Name: "server.event-threads", OnValue: "4"}},
		"Enable this profile for use cases consisting of mostly large files like video surveillance, backup, video streaming and others, with native FUSE mount access of a Eurasure coded volume"},
