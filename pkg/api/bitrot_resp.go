...
// BitrotScrubNodeInfo contains information about the scrub status for node
// Clients should NOT use this struct directly.
type BitrotScrubNodeInfo struct {
...
// BitrotScrubStatus contains information about the scrub status for volume.
// Clients should NOT use this struct directly.
type BitrotScrubStatus struct {
	...
	Nodes        []BitrotScrubNodeInfo `json:"nodes"`
}
